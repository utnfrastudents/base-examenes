...
void entities_hardcode(sEntity entitiesList[], int entitiesLength)
{
    ...
    sEntity auxEntity[] = {
        {entities_getNewId(), "entidad 01"},
        {entities_getNewId(), "entidad 02"},
        {entities_getNewId(), "entidad 03"},
        {entities_getNewId(), "entidad 04"},
        {entities_getNewId(), "entidad 05"},
        {entities_getNewId(), "entidad 06"},
        {entities_getNewId(), "entidad 07"},
        {entities_getNewId(), "entidad 08"},
        {entities_getNewId(), "entidad 09"},
